...
const AddSkill = forwardRef((props, ref) => {
  ...
  const saveSkillToEmployee = (skill, employee) => {
    ...
    if (!currentUser?.id) {
      ...
      const addSkillToEmployee = new AddSkillToEmployee(
        employee.id,
        skill.skillId
      );

      AddSkillToEmployeeService.saveAddSkillToEmployee(addSkillToEmployee)
        .then(() => {
      ...
      >
        ...
        <div className="modal-footer">
          ...
          <button
            ...
            onClick={() => saveSkillToEmployee(skill, employee)}
          >
            SAVE SKILL
          </button>
        </div>
